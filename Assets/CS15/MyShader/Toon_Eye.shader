    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                half env_lumin = dot(final_env,float3(0.299f,0.587f,0.144f));
                final_env = final_env * env_lumin;

                half3 final_color = pow(final_env,2.2) * final_diffuse + final_diffuse + decal_color;
